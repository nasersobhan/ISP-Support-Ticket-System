        ...
        <div class="page-header ">
            ...
            <nav class="navbar navbar-default" role="navigation">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                                    ...
                                                    <form method="post" action="<?php echo get_link(is_get('pg'),'list','all&search=1'); ?>" class="navbar-form navbar-left" role="search">
							...
							<ul class="nav navbar-nav navbar-right">
								<li>
									<a href="<?php echo get_link(is_get('pg'),'add','new'); ?>">Add New</a>
								</li>
								<li class="dropdown">
