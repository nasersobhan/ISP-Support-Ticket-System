...
//    return $final_name;
//}
if($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' && isset($_FILES['oy_upload']) && $_FILES['oy_upload']['name'] != NULL && is_loggedin() ) {
    //$originalName = $_FILES['oy_upload']['name'];
    
    $file = upload_it($_FILES['oy_upload']);
    
    $fileName = get_fileurl($file['id']);
//    $rootPath = 'images/';
