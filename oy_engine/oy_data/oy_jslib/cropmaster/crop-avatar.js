(function (factory) {
  ...
  function CropAvatar($element) {
    ...
    this.$avatarView = this.$container.find(".avatar-view img");
    this.$avatar = this.$avatarView;
    this.$avatarModal = this.$container.find("#avatar-modal");
    this.$loading = $("#xloading");
    ...
    this.$avatarPreview = this.$avatarModal.find(".avatar-preview");
 	this.$ratio = this.$avatarModal.find(".avatar-ratio").val();
    this.init();
    //console.log(this);
  }
  ...
  CropAvatar.prototype = {
    ...
    submitDone: function (data) {
      ...
      if (data && data.state === 200) {
        ...
        this.alert("Failed to response1");
      }
    },
  ...
  $(function () {
	...
	var examplex = new CropAvatar($("#crop-cover"));
  });
});
