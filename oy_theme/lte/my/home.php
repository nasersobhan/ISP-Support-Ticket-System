    ...
    <div class="col-md-4">
        <div class="panel-group">
            <div class="panel panel-default">
                ...
                <a href="<?Php echo HOME. '?pg=list&list=customers' ?>" class="pull-left" ><i class="fas fa-list"></i></a>
                </div>
...
<div class="col-md-4">
        <div class="panel-group">
            <div class="panel panel-default">
                ...
                <a href="<?Php echo HOME. '?pg=list' ?>" class="pull-left" ><i class="fas fa-list"></i></a>
                </div>
    ...
    <div class="col-md-4">
        <div class="panel-group">
            <div class="panel panel-default">
                ...
                <a href="<?Php echo HOME.'?pg=todo'; ?>" class="pull-left" ><i class="fas fa-list"></i></a>
                </div>
                <span id="todolist">
...
<div class="panel-group">
            <div class="panel panel-default">
                ...
                <a href="<?Php echo HOME.'?pg=categories&t=groups'; ?>" class="pull-left" ><i class="fas fa-list"></i></a>
                </div>
...
آخرین پیامها                    </a>
                ...
                <a href="<?php echo HOME.'?pg=inbox '; ?>" class="pull-left" ><i class="fas fa-list"></i></a>
                </div>
...
<div class="panel-group">
    <div class="panel panel-default">
        ...
        <?php if(user_rank() == 99) { ?>
            <a href="<?php echo HOME.'?pg=users '; ?> #main-form" data-toggle="modal" data-target="#Uni-modal" class="pull-left tip" title="ایجاد کاربر جدید" ><i class="fas fa-user-plus"></i></a>
            <?php } ?>
        </div>
